...
var me = "style[".concat(f, "][").concat("data-styled-version", '="').concat("6.0.4", '"]');
...
var we = function(e) {
  ...
  o2.setAttribute(f, "active"), o2.setAttribute("data-styled-version", "6.0.4");
  var i2 = Se();
...
var Ce = function() {
  ...
  return e.registerId = function(e2) {
    ...
    return this.tag || (this.tag = (e2 = function(e3) {
      ...
      return e3.isServer ? new Ne(n) : t ? new Ee(n) : new be(n);
...
function De(e) {
  var t, n, o2, r2 = void 0 === e ? N : e, s2 = r2.options, i2 = void 0 === s2 ? N : s2, a2 = r2.plugins, c2 = void 0 === a2 ? b : a2, l2 = function(e2, o3, r3) {
...
function Ge(e, t, n, o2) {
  ...
  var s2;
  return e instanceof Fe ? n ? (e.inject(n, o2), [e.getName(o2)]) : [e] : oe(e) ? Le(e) : Array.isArray(e) ? Array.prototype.concat.apply(b, e.map(function(e2) {
    return Ge(e2, t, n, o2);
  })) : [e.toString()];
}
function Ye(e) {
...
function Qe(e, r2, s2) {
  var i2 = ee(e), a2 = e, c2 = !M(e), p2 = r2.attrs, d = void 0 === p2 ? b : p2, h = r2.componentId, f2 = void 0 === h ? function(e2, t) {
    var n = "string" != typeof e2 ? "sc" : A(e2);
    Ze[n] = (Ze[n] || 0) + 1;
    var o2 = "".concat(n, "-").concat(x("6.0.4" + n + Ze[n]));
  ...
  function O2(e2, r3) {
    return function(e3, r4, s3) {
      ...
      var b2 = te(p3, d2);
      return E2 && (b2 += " " + E2), v3.className && (b2 += " " + v3.className), S3[M(g3) && !_.has(g3) ? "class" : "className"] = b2, S3.ref = s3, (0, import_react.createElement)(g3, S3);
    }(D2, e2, r3);
  }
  O2.displayName = y2;
  ...
  } }), E(y2, v2), D2.warnTooManyClasses = function(e2, t) {
    var n = {}, o2 = false;
    return function(r3) {
...
function nt(t) {
  ...
  if (Q(t) || oe(t)) {
    var r2 = t;
    return tt(Ge(et(b, __spreadArray([r2], n, true))));
  }
  var s2 = t;
...
function at(n) {
  ...
  var l2 = function(e) {
    ...
    }) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), t.styleSheet.server && u2(r3, e, t.styleSheet, n2, t.stylis), (import_react.default.useInsertionEffect || import_react.default.useLayoutEffect)(function() {
...
var ut = function() {
  function e() {
    ...
    this._emitSheetCSS = function() {
      var t = e2.instance.toString(), n = Se(), o2 = ne([n && 'nonce="'.concat(n, '"'), "".concat(f, '="true"'), "".concat("data-styled-version", '="').concat("6.0.4", '"')].filter(Boolean), " ");
      ...
      if (e2.sealed)
        throw ce(2);
      var r2 = ((n = {})[f] = "", n["data-styled-version"] = "6.0.4", n.dangerouslySetInnerHTML = { __html: e2.instance.toString() }, n), s2 = Se();
